        ...
        <section class="brands-section" id="brands">
            ...
            <div class="brands-container">
                ...
                <div class="brands-grid">
                    ...
                    <!-- APPLE -->
                    <a href="products-listing/index.html" class="brand-card">
                    ...
                    <a href="products-listing/index.html" class="brand-card">
                        ...
                        <div class="brand-card-logo">
                            <img src="https://cdn.simpleicons.org/samsung" alt="Samsung" loading="lazy">
                        </div>
                    ...
                    <a href="products-listing/index.html" class="brand-card">
                        ...
                        <div class="brand-card-logo">
                            <img src="https://cdn.simpleicons.org/xiaomi" alt="Xiaomi" loading="lazy">
                        </div>
                    ...
                    <a href="products-listing/index.html" class="brand-card">
                        ...
                        <div class="brand-card-logo">
                            <img src="https://cdn.simpleicons.org/huawei" alt="Huawei" loading="lazy">
                        </div>
                    ...
                    <a href="products-listing/index.html" class="brand-card">
                        ...
                        <div class="brand-card-logo">
                            <img src="https://cdn.simpleicons.org/oppo" alt="Oppo" loading="lazy">
                        </div>
            ...
            <div class="featured-products__container">
                ...
                <div class="featured-products__grid">
                    ...
                    <article class="product-card">
                        ...
                        <a href="single/index.html" class="product-card__image">
                        ...
                        <div class="product-card__content">
                            ...
                            <div class="product-card__bottom">
                                ...
                                <div class="product-card__price">
                                    <span>Price</span>
                                    <strong>12,499 DH</strong>
                                </div>

                                <a href="single/index.html" class="product-card__button"
                                    aria-label="View iPhone 15 Pro">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M5 12h14M13 6l6 6-6 6" />
                                    </svg>
                    ...
                    <article class="product-card">
                        ...
                        <div class="product-card__content">
                            ...
                            <div class="product-card__bottom">
                                ...
                                <div class="product-card__price">
                                    <span>Price</span>
                                    <strong>11,999 DH</strong>
                                </div>

                                <a href="single/index.html" class="product-card__button"
                                    aria-label="View Galaxy S24 Ultra">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M5 12h14M13 6l6 6-6 6" />
                                    </svg>
                    ...
                    <article class="product-card">
                        ...
                        <div class="product-card__content">
                            ...
                            <div class="product-card__bottom">
                                ...
                                <div class="product-card__price">
                                    <span>Price</span>
                                    <strong>7,499 DH</strong>
                                </div>

                                <a href="single/index.html" class="product-card__button" aria-label="View Xiaomi 14">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M5 12h14M13 6l6 6-6 6" />
                                    </svg>
                    ...
                    <article class="product-card">
                        ...
                        <div class="product-card__content">
                            ...
                            <div class="product-card__bottom">
                                ...
                                <div class="product-card__price">
                                    <span>Price</span>
                                    <strong>9,499 DH</strong>
                                </div>

                                <a href="single/index.html" class="product-card__button"
                                    aria-label="View Google Pixel 9 Pro">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M5 12h14M13 6l6 6-6 6" />
                                    </svg>
    ...
    <footer class="site-footer">
        ...
        <div class="footer-main">
            <div class="footer-container">
                ...
                <div class="footer-brand">
                    ...
                    <div class="footer-socials">
                        ...
                        <a href="#" aria-label="WhatsApp">
                            <svg viewBox="0 0 24 24" aria-hidden="true">
                                <path d="M20 11.7a8 8 0 0 1-11.8 7l-4.2 1.1 1.1-4A8 8 0 1 1 20 11.7Z" fill="none"
                        ...
                        <a href="#" aria-label="TikTok">
                            <svg viewBox="0 0 24 24" aria-hidden="true">
                                <path d="M14 4v10.2a3.8 3.8 0 1 1-3-3.7" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" />
                                <path d="M14 4c.5 2.6 2.2 4.2 5 4.7" fill="none" stroke="currentColor" stroke-width="2"
                ...
                <div class="footer-column">
                    ...
                    <nav>
                        <a href="products-listing/index.html">Apple</a>
                        <a href="products-listing/index.html">Sumsung</a>
                        <a href="products-listing/index.html">Xiaomi</a>
                        <a href="products-listing/index.html">Huawei</a>
                        <a href="products-listing/index.html">Oppo</a>
                        <a href="products-listing/index.html">Google</a>
                    </nav>
                ...
                <div class="footer-column footer-contact">
                    ...
                    <a href="tel:+212600000000" class="contact-item">
                    ...
                    <a href="mailto:contact@phonestore.com" class="contact-item">
                    ...
                    <div class="contact-item">
                        ...
                        <span class="contact-icon">
                            <svg viewBox="0 0 24 24" aria-hidden="true">
                                <path d="M12 21s6-5.2 6-11a6 6 0 1 0-12 0c0 5.8 6 11 6 11Z" fill="none"
        ...
        <div class="footer-bottom">
            ...
            <div class="footer-bottom-container">
                ...
                <p>
                    © <span id="footerYear"></span> Phone Store.
                    All rights reserved.
                </p>
